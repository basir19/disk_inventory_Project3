...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <tr style="background-color: #FFCC66; color: #000080;">
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Text="*" CssClass="text-danger"
                        ControlToValidate="ArtistFirstNameTextBox" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
                <td>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Text="*" CssClass="text-danger"
                        ControlToValidate="ArtistTypeIDTextBox" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
            </tr>
        </EditItemTemplate>
        <%-- Empty Item template --%>
    ...
    <asp:SqlDataSource ID="lvArtist" runat="server"
        ...
        SelectCommand="SELECT [ArtistID], [ArtistFirstName], [ArtistLastName], [ArtistTypeID] FROM [Artist] WHERE ([ArtistTypeID] = @ArtistTypeID) ORDER BY [ArtistLastName]"
